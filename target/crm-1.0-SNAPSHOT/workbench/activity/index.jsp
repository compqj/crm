...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			/*
				需要操作的模态窗口的jquery对象，调用modal方法，为该方法传递参数 show:打开窗口 hide：关闭窗口
			 */
			// alert(111);
								...
								<%--
									关于文本域textarea:
										...
										(2) textarea虽然是以标签对的形式来呈现的，但是它也是属于表单元素范畴
											我们所有的对于textarea的取值和赋值操作，应该统—使用vaL()方法(而不是html()方法)
