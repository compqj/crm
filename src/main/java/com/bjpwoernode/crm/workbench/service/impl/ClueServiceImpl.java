...
import com.bjpwoernode.crm.workbench.dao.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //经过第二步处理后，客户信息已经拿到了,将来在处理其他表的时候，如果要使用到客户的id
        //直接使用cus.getId()
        ...
        //经过第三步处理后，联系人信息已经拿到了,将来在处理其他表的时候，如果要使用到联系人的id
        //直接使用con.getId()
        ...
        for(ClueRemark clueRemark : clueRemarkList){
            ...
            customerRemark.setEditFlag("0");//0:未修改过，1：修改过
            ...
            contactsRemark.setEditFlag("0");//0:未修改过，1：修改过
