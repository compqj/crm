...
<script type="text/javascript">
	...
	$(function(){
		...
		showActivityList();
		//页面加载完毕后，取出关联的线索备注信息列表
		showRemarkList();

        //为关联市场活动按钮绑定事件，打开模态窗口并优化体验
        ...
        //为关联市场活动的模态窗口中的搜索框绑定事件，回车查询并展现所需市场活动列表
		...
		$("#bundBtn").click(function () {
			...
			if ($xz.length == 0){
				...
				//1条或者多条   //workbench/cLue/bund.do?cid=xxx&aid=xxx&aid=xxx&aid=xxx
				var param = "cid=${c.id}&";
				...
				$.ajax({
					...
					success : function (data) {
						if (data.success){
							...
							//刷新关联市场活动列表
							showActivityList();
							//清除搜索框中的信息(ok) 复选框的选中干掉(ok) 清空activitySearchBody中的内容(ok)
							$("#aName").val("");
							//清空activitySearchBody中的内容
							$("#activitySearchBody").html("");
							//关闭模态窗口
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				...
				<a href="javascript:void(0);" id="activityBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
